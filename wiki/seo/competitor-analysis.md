...
Trading852 operates in a small but high-intent niche: **English-language, independent research on HKEX-listed companies**, focused on value investing and special situations. The space has few serious players, which is a structural advantage.

---

## Direct Competitors

### 1. Asian Century Stocks
- **URL**: asiancenturystocks.com (Substack)
...
### 2. Webb-site (webb-site.com)
- **URL**: webb-site.com
- **Format**: Static site, no CMS
...
- **Format**: Contributor platform
- **Focus**: Crowd-sourced analysis, broad coverage
- **Strengths**: Massive domain authority; ranks for almost any stock ticker search; broad monetization
- **Weaknesses**: Quality inconsistent; paywalled; generic tone; no HKEX specialisation or editorial voice
- **E-E-A-T**: Weak per-author; strong platform-level
- **Gap Trading852 can exploit**: Consistent editorial voice, HKEX specialisation, no paywall, deeper SOTP methodology
...
| Competitor | Why Indirect | Their Strength | Our Angle |
|---|---|---|---|
| Moomoo / Futu blog | Broker-owned, promotional | Traffic from user base | Independent, no conflicts |
| Simply Wall St | Data visualisation | Automated, broad coverage | Narrative depth, original thesis |
| TradingView community | Chart-focused | Volume | Fundamental analysis |
| SCMP Business | News outlet | Breaking news | Research depth, not news |
...
## E-E-A-T Competitive Assessment

| Signal | Webb-site | Asian Century | Trading852 (current) | Trading852 (target) |
|---|---|---|---|---|
